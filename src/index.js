...
(function () {
  ...
  function createBookCard(name, author, pages, isRead, Id) {
    ...
    [
      ...
      addBookInput,
      bookRemoveBtn,
    ].forEach((bookElement) => bookCard.appendChild(bookElement));
  ...
  function formSubmitHandler(e) {
    ...
    titleInput.addEventListener("input", () => console.log("hi"));
  ...
  titleInput.addEventListener("input", inputValidator);
  ...
  function bookContainerHandler(e) {
    let bookId = e.srcElement.parentElement.id;
